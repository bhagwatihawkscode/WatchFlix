...
import "./style.css";
import demo from "../assests/imgsecond.png";
import demo1 from "../assests/image 1 (1).png";
      ...
      <div className="home-container">
        <div className="top-container">
          ...
          <div className="container-3">
            <h1
              style={{ color: "#FFF", fontSize: "3rem", margin: "10px 20px" }}
            >
              Laughter. Tears. Thrills. Find it all on WatchFlix.
            </h1>
            <p
              style={{
                color: "#FFF ",
      ...
      <div className="second-container">
        <div style={{ display: "flex" }} className="image-container">
          ...
          <div
            ...
            className="image-size-set"
          >
            <img src={demo1} alt="settle" />
          </div>
        </div>
      </div>
      <div className="second-container">
        ...
        >
          ...
          <div className="content-container">
            ...
            >
              The ultimate escape, where stories unfold and emotions ignite.
              Explore the magic of cinema, where every frame is a new adventure
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <div style={{ color: "#fff", fontSize: "0.5rem" }}>
            ©Copyright 2023 WATCHFLIX . All rights reserved.
          </div>
